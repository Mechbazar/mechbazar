...
// This app signs in through POST /auth/admin/login's email+password path,
// which bcrypt-compares User.password -- NOT the Firebase credential the
// admin *web* panel uses. So the change has to go through the backend
// endpoint; Firebase's updatePassword would leave this app's actual login
// untouched.
