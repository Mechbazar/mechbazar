  ...
  const handleSubmit = async () => {
    ...
    try {
      const data = mode === 'login'
        ? await technicianService.login({ phone: normalizedPhone, otp: idToken })
        : await technicianService.register({ phone: normalizedPhone, otp: idToken, name: name.trim(), email: email.trim() || undefined });
