...
// Keys match ServiceTechnician.status (TechnicianStatus enum) exactly -- the
// same value set as DeliveryPartner.status, so this map is a near-verbatim
// port of rider's StatusScreen.
