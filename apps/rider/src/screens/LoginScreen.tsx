...
// way the phone+OTP flow works for every role today: the backend accepts a
// dev-bypass OTP of '123456' (no real Firebase SMS verification wired up
// here yet — see the final gaps report). New riders can also self-register
// here (the only entry point into the KYC wizard, see RootNavigator).
