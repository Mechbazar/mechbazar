...
// Please re-send the verification code to try again.") rather than for a rider
// trying to get to work. LoginScreen shows `err.message` directly, so an
// unmapped code puts that raw bracketed string straight on screen. This maps
