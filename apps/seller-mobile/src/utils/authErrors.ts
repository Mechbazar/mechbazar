...
// seller trying to log in. This maps the handful of codes real users can
// actually hit; anything unmapped falls back to a generic retry message
// instead of the raw Firebase text.
//
// Mirrors apps/mobile/src/utils/authErrors.ts and apps/rider's copy of the
// same file.
