...
export default function SalesChart() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${API_URL}/vendors/dashboard/sales-chart?days=${days}`, { headers: { Authorization: `Bearer ${token}` } })
      ...
      {loading ? (
        ...
        <ResponsiveContainer width="100%" height={260}>
          <AreaChart data={data} margin={{ top: 5, right: 10, left: 0, bottom: 0 }}>
            ...
            <Area type="monotone" dataKey="revenue" stroke="#DA3830" strokeWidth={2} fill="url(#vendorRevenueFill)" />
          </AreaChart>
        </ResponsiveContainer>
      )}
    </Card>
