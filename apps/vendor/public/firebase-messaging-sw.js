...
// Foreground messages are handled in src/services/webPush.ts instead, via
// onMessage(). Copied from apps/mobile/public/firebase-messaging-sw.js --
// same Firebase project (mech-bazar-8fd86), so same config.
importScripts('https://www.gstatic.com/firebasejs/12.16.0/firebase-app-compat.js');
importScripts('https://www.gstatic.com/firebasejs/12.16.0/firebase-messaging-compat.js');

// Same config as src/config/firebase.ts -- a service worker runs in its own
