...
//
// base64-encoded rather than `;utf8,` + encodeURIComponent (CJ-03 fix):
// `;utf8` isn't a valid RFC 2397 MIME parameter (parameters need `attr=value`,
// e.g. `;charset=utf-8`), which some renderers reject outright, and a
// percent-encoded payload silently breaks if anything downstream ever runs
// encodeURIComponent on the already-encoded string a second time (exactly
// what was seen corrupting a couple of homepage product-card thumbnails --
// %3C becoming %253C). A base64 payload has no `%` characters to mangle and
// is unambiguous everywhere this string gets passed as an <img>/Image source.
// Precomputed once from the SVG markup below -- see git history for the
// pre-base64 source if this ever needs to be regenerated by hand.
export const NO_IMAGE_PLACEHOLDER =
  'data:image/svg+xml;base64,' +
  '';
