...
|---|---|---|
| **Confirmed** — not yet picked or packed | **Yes**, directly in the app | None. Full refund |
| **Packed** — not yet handed to the rider or carrier | **Yes**, subject to Vendor confirmation | None in most cases |
| **Dispatched / Out for Delivery** | **No** in-app cancellation | Refuse the delivery, or accept and raise a return |
| **Delivered** | No — use the return route instead | See [Return & Replacement Policy](return-replacement-policy.md) |
...
4. You receive a cancellation confirmation, and any refund is initiated
   automatically

If the **Cancel** button is no longer available, the Order has already been
dispatched. In that case you may simply **refuse the package at the door**. Since
every Order is Cash on Delivery, refusing costs you nothing — no money has
changed hands and there is nothing to refund.

### Non-cancellable Orders

The following cannot be cancelled once confirmed, because procurement or
processing begins immediately:

- **Made-to-order, custom, special-order or imported-on-request** parts;
- Items expressly marked **"Non-cancellable"** on the product page;
- Orders that have already been delivered.

---

## 3. Cancellation of Service Bookings by You
...
a. the item is **out of stock** or discontinued at the time of fulfilment;
b. the delivery or service address is **outside the serviceable area**, or is
   unsafe or inaccessible;
c. there is a **pricing, stock, description or listing error**;
d. the **vehicle details are incompatible** with the part ordered, and the
   mismatch is detected before dispatch;
e. the Order or account is flagged for **suspected fraud, abuse, resale activity
   or promotion abuse**;
f. **payment fails**, is reversed, or cannot be verified;
g. a **prior COD amount is outstanding** on your account;
h. delivery or service cannot be performed due to **force majeure**;
i. no **Mechanic is available** for the selected slot, or the assigned Mechanic
   is unable to attend and no substitute can be arranged;
j. the requested work is **unsafe, unlawful, or beyond the scope** of doorstep
   servicing (see [Terms and Conditions](terms-and-conditions.md), Section 8).

**In every case of cancellation by us, a Vendor or a Mechanic, you receive a full
refund of all amounts paid, including delivery and handling charges, at no cost
to you.** Where possible we will first offer an alternative — a substitute part
of equivalent or better specification, a revised slot, or a partial dispatch —
and proceed only with your consent.
...
## 6. Effect of Cancellation on Coupons and Credits
...
We monitor cancellation patterns to protect Vendors, Mechanics and Delivery
Partners from avoidable loss. Where an account shows an unusually high rate of
last-minute cancellations, refused COD deliveries or service no-shows, we may:

- require **prepayment** on future Orders and Bookings;
- **withdraw COD** eligibility;
- **restrict or suspend** the account.

You will be informed before any such restriction takes effect, and may escalate
