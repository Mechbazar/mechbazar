...
We are here for anything to do with your order, your booking, your vehicle
fitment questions, or your account.
...
information already attached, so we can act without a round of clarifying
questions.
...
We follow a three-level escalation process, in accordance with the **Consumer
Protection (E-Commerce) Rules, 2020** and the **Information Technology
...
If Level 1 has not resolved your issue within the promised time, or you are
...
- **National Consumer Helpline** — dial **1915**, or visit consumerhelpline.gov.in
- **e-Daakhil portal** — edaakhil.nic.in
- The **Consumer Disputes Redressal Commission** having jurisdiction
- The **Data Protection Board of India**, for data-protection complaints, once
  constituted under the Digital Personal Data Protection Act, 2023

---

## Nodal Contact Person

For coordination with law enforcement agencies, in accordance with the
...
To help us resolve your issue in a single exchange, please include:

- your **registered mobile number**;
- the **Order ID** or **Booking ID**;
- your **vehicle details** — make, model, variant, year — for any fitment issue;
- the **part number** printed on the item, for a wrong-part or defect claim;
- **photographs** of the item, its packaging, its label and the defect;
- the **unboxing video**, if you recorded one, for damage or shortage claims.
