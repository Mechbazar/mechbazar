...
and the rules thereunder, and is published in accordance with Rule 3(1) of the
Information Technology (Intermediary Guidelines and Digital Media Ethics Code)
Rules, 2021. It does not require any physical or digital signature.

**By accessing, browsing, registering on, or transacting through the Platform,
you agree to be bound by these Terms, the [Privacy Policy](privacy-policy.md),
and all other policies referenced here.** If you do not agree, you must
...
- **"Mechanic"** / **"Technician"** — an independent verified service
  professional who performs doorstep or workshop Services booked through the
  Platform.
- **"Delivery Partner"** / **"Rider"** — a person or agency engaged for last-mile
  delivery.
- **"Products"** — automotive spare parts, accessories, consumables, lubricants,
  batteries, tyres, tools and related goods listed on the Platform.
- **"Services"** — vehicle repair, periodic servicing, inspection, roadside
  assistance and other work booked through the Platform.
- **"Order"** — a request to purchase Products; **"Booking"** — a request for
  Services.
...
b. are competent to contract under the **Indian Contract Act, 1872**;
c. are not barred from receiving services under any applicable law; and
d. are accessing the Platform from within the territory of India, for delivery to
   a serviceable Indian address.

If you are registering on behalf of a business (for example a garage, fleet
operator or workshop), you represent that you are authorised to bind that entity,
and that any GSTIN provided is valid and belongs to it.
...
a. Registration requires a valid **Indian mobile number**, verified by a
...
d. One person may hold one account. Creating multiple accounts to abuse
   promotions, referrals, first-order discounts or return policies is
   prohibited.
e. We may suspend or terminate an account, cancel pending Orders, and withhold
   promotional benefits where we reasonably believe there has been fraud, abuse,
   misrepresentation, chargeback abuse, repeated unjustified refusal of COD
   deliveries, or a breach of these Terms.

---

## 6. Product Listings, Fitment and Genuineness

### 6.1 Fitment is your responsibility to confirm

Automotive parts are vehicle-specific. The Platform provides fitment filters
based on the make, model, variant, fuel type and manufacturing year saved in your
**Garage**, along with OEM/OE part numbers where available.

**These filters are an aid, not a guarantee.** Fitment can vary with mid-cycle
manufacturer changes, facelifts, regional variants, and prior modifications or
repairs to your vehicle. **Before purchase you should verify the part number
against the part currently fitted on your vehicle, or consult a qualified
mechanic.** Orders placed on the basis of incorrect vehicle details entered by
you are treated as incorrect-selection returns under the
[Return & Replacement Policy](return-replacement-policy.md).

### 6.2 Genuine, OEM, OES and aftermarket

Listings are labelled as **Genuine/OEM**, **OES**, **Aftermarket**,
**Remanufactured** or **Refurbished**. Aftermarket and remanufactured parts are
not manufactured by the vehicle manufacturer and may carry a different warranty.
Fitting a non-OEM part may, depending on the manufacturer's terms, affect the
warranty on your vehicle. You accept this risk when you select such a part.

### 6.3 Accuracy of listing content

Images, dimensions, weights, colours and technical specifications are indicative
and are supplied by Vendors or manufacturers. Minor variation between the image
and the delivered item — including changes in manufacturer packaging or
branding — does not by itself constitute a defect.

### 6.4 Restricted and regulated goods

Certain goods are sold subject to statutory conditions, including lead-acid
batteries (Battery Waste Management Rules, 2022 — old battery exchange may be
required), tyres (BIS marking), lubricants and flammable fluids (transport
restrictions), airbags, seat belts and other safety-critical components,
and speed-governing or emission-related components. Sale, delivery or return of
such goods may be restricted or conditioned in accordance with law, and some
items may be non-returnable once the seal is broken.

### 6.5 Pricing and errors

a. Prices are set by Vendors and are inclusive of GST unless stated otherwise.
   Delivery charges, express-delivery charges, COD handling fees and other levies
...
## 7. Orders, Quick Commerce and Delivery

a. Placing an Order constitutes an **offer** to purchase. The contract is formed
...
b. Delivery timelines — including any express or quick-commerce timeline of
   ...
   remedies stated in the [Shipping Policy](shipping-policy.md).
c. Risk in the Products passes to you on delivery. Title passes on delivery, or
   on receipt of full payment, whichever is later.
d. You or an authorised person must be available at the delivery address. We may
   require an OTP or signature at handover. Repeated failed delivery attempts may
   result in the Order being cancelled and returned to the Vendor.
e. Full details are set out in the [Shipping Policy](shipping-policy.md).
...
c. Service completion may be confirmed by an **OTP shared by you** to the
   Mechanic. Do not share the completion OTP before the work is actually done.
d. **Diagnosis and estimates.** Initial pricing is indicative. Where additional
   defects, parts or labour are discovered on inspection, the Mechanic will seek
   your approval for the revised estimate before proceeding. You may decline, in
   which case an inspection or visitation charge may still apply.
e. **Your obligations.** You must provide safe, lawful and reasonable access to
   the vehicle and adequate working space; ensure the vehicle is legally parked;
   remove valuables from the vehicle; and disclose known defects, prior repairs,
   modifications and accident history.
f. **Exclusions.** Mechanics may decline work that is unsafe, requires a lift,
   specialised workshop equipment or a controlled environment, involves
   structural or accident repair, involves tampering with odometers, emission
...
c. **No amount is payable before fulfilment.** Placing an Order or a Booking
   creates no payment obligation until the goods are delivered or the Service
   is performed.
...
## 10. Cancellations, Returns, Replacements and Refunds

These are governed by the following documents, which form part of these Terms:
...
## 11. Promotions, Coupons and Credits

a. Coupons, offers and promotional credits are subject to the specific terms
   published with each offer, are non-transferable, have no cash value, and
   cannot be exchanged for currency.
b. Offers may be withdrawn, modified or restricted at any time without notice.
c. Where an Order that used a coupon is cancelled or returned, the coupon's value
   is not refunded in cash. A single-use coupon may or may not be reinstated, at
   our discretion.
d. Abuse of promotions — including bulk ordering for resale, use of multiple
   accounts, or manipulation of referral programmes — will result in
   cancellation of the benefit, reversal of credits, and possible account
   suspension.
...
c. You represent that your User Content is your own, is accurate, is based on
   actual use, and does not infringe any third-party right.
d. We may moderate, refuse to publish, or remove User Content that is unlawful,
   obscene, defamatory, misleading, promotional, or that constitutes a paid or
   fake review, in accordance with applicable standards on consumer reviews.
...
a. host, display, upload, publish or share information that is defamatory,
   obscene, invasive of another's privacy, hateful, harmful to a child, or
   otherwise unlawful, or that infringes any patent, trademark, copyright or
   other proprietary right, or that violates any law in force — as set out in
   Rule 3(1)(b) of the Information Technology (Intermediary Guidelines and
   Digital Media Ethics Code) Rules, 2021;
b. impersonate any person, or provide false vehicle, identity, address or
   payment information;
c. use the Platform to purchase Products for resale without a valid, disclosed
   business arrangement;
d. attempt to gain unauthorised access to the Platform, its servers, or the
   accounts of other Users;
e. scrape, crawl, mine, index or otherwise extract data from the Platform, or
   reverse engineer, decompile or disassemble the app, except to the extent
   permitted by law;
f. introduce viruses, malware or any code designed to disrupt the Platform;
g. circumvent OTP verification, rate limits, geographic restrictions or
   fraud controls;
h. harass, threaten or abuse Vendors, Mechanics, Delivery Partners or support
   personnel;
i. use the Platform to source parts for tampering with vehicle identification
   numbers, odometers, emission-control systems or safety systems, or for any
   other unlawful purpose.

We may report violations to law enforcement and cooperate with investigations.
...
the Platform grants any licence to use any mark without written permission.

You are granted a limited, revocable, non-exclusive, non-transferable licence to
install and use the app on a device you own or control, for personal,
...
The Platform integrates third-party services including map and navigation
services, authentication and messaging services, analytics and logistics
providers. (No payment gateway or aggregator is integrated — the Platform is
Cash on Delivery only.) Your use of those features may additionally be governed
by the terms of those providers. We are not responsible for the acts, omissions
...
a. The Platform is provided on an **"as is"** and **"as available"** basis. We do
   not warrant uninterrupted or error-free operation, or that defects will be
   corrected.
b. We do not warrant the quality, genuineness, fitment, merchantability or
   fitness for a particular purpose of any Product listed by a Vendor, or the
   quality of any Service performed by a Mechanic, beyond the obligations imposed
   on marketplace e-commerce entities by law.
c. Any technical guidance, fitment suggestion, maintenance schedule or diagnostic
   information provided on the Platform is **general information, not
   professional advice**, and must not be relied upon in place of inspection by a
   qualified mechanic. Automotive repair carries inherent risk; incorrect
   installation of parts can cause vehicle damage, injury or death.
d. **Do not attempt safety-critical repairs — including brakes, steering,
   suspension, airbags, fuel systems and high-voltage EV components — without
   appropriate qualification and equipment.**
...
c. Nothing in these Terms excludes or limits liability that cannot be excluded or
   limited under Indian law, including liability under the Consumer Protection
   Act, 2019 for death or personal injury caused by proven negligence, or for
   fraud.
...
of any third-party right; (c) User Content posted by you; or (d) your negligent
or unlawful use of any Product or Service obtained through the Platform.
...
events beyond its reasonable control, including acts of God, flood, fire,
earthquake, epidemic or pandemic, war, terrorism, civil unrest, strikes, labour
disputes, government action, curfews, transport restrictions, fuel shortage,
internet or telecommunications failure, or failure of a payment or logistics
partner.
...
a. You may stop using the Platform at any time and may request deletion of your
   account in accordance with the
   [Account Deletion Policy](account-deletion-policy.md).
b. We may suspend or terminate your access, with or without notice, for breach of
   these Terms, suspected fraud or abuse, or where required by law.
c. Termination does not affect accrued rights and obligations, including payment
   for Orders already delivered or Services already performed.
d. Sections on intellectual property, disclaimers, limitation of liability,
   indemnity, governing law and dispute resolution survive termination.

---

## 21. Governing Law and Dispute Resolution

a. These Terms are governed by and construed in accordance with the **laws of
   India**.
b. **Grievance first.** Before initiating any formal proceedings, you agree to
   raise the dispute with our Grievance Officer (Section 23) and allow **30 days**
   for resolution.
...
e. **Consumer rights preserved.** Nothing in this Section restricts your right as
   ...
   or the e-Daakhil portal.

---

## 22. General

a. **Severability** — if any provision is held invalid or unenforceable, the
   remaining provisions continue in full force.
b. **No waiver** — failure to enforce any provision is not a waiver of it.
c. **Assignment** — you may not assign these Terms; we may assign them to an
